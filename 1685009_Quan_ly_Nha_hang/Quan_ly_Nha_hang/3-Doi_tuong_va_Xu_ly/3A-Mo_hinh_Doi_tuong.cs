...
public partial class XL_DU_LIEU
{
    ...
    public List<XL_PHIEU_DAT_BAN> Danh_sach_Phieu_Dat_ban = new List<XL_PHIEU_DAT_BAN>();
...
public class XL_NGUOI_DUNG
{
    ...
    // Tính toán
    public long Doanh_thu_Ngay;
    public long Doanh_thu_Thang;
    public long Doanh_thu_Tong;

    // Online 
    public List<XL_NGUOI_DUNG> Danh_sach_Nhan_vien_Phuc_vu = new List<XL_NGUOI_DUNG>();
    public List<XL_LOAI_MON_AN> Danh_sach_Loai_Mon_an = new List<XL_LOAI_MON_AN>();
    ...
    public List<XL_PHIEU_DAT_BAN> Danh_sach_Phieu_Dat_ban = new List<XL_PHIEU_DAT_BAN>();
    public List<XL_PHIEU_DAT_BAN> Danh_sach_Phieu_Dat_ban_Xem = new List<XL_PHIEU_DAT_BAN>();
    public List<XL_PHIEU_TINH_TIEN> Danh_sach_Phieu_Tinh_tien = new List<XL_PHIEU_TINH_TIEN>();
    public List<XL_Y_KIEN> Danh_sach_Y_kien = new List<XL_Y_KIEN>();
    public List<XL_Y_KIEN> Danh_sach_Y_kien_Xem = new List<XL_Y_KIEN>();
}
...
public class XL_PHIEU_DAT_BAN
{
    ...
    public string Trang_thai = "TIEP_NHAN";
}